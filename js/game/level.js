...
Game.confirmRestart = function() {
	Popup.confirm('Restart ?', null, Game.restart);
	Game.removeHint();
};
...
Game.endLevel = function() {
	Popup.alert('Level ' + Game.level + ' Complete !', Game.nextLevel);
	Game.removeHint();
}
...
Game.gameOver = function() {
	Popup.confirm('No more moves possible.<br/>Restart ?', null, Game.restart);
	Game.paused = true;
};